...
const product = "https://beta-sports"
var alllabelnames= ["pa.betmgm","mi.betmgm","sportingbet","bwin","gamebookers","partypoker","premium","nj.betmgm","partycasino","co.betmgm"
,"wv.betmgm","in.betmgm","borgataonline","br.betboo","tn.betmgm","il.betmgm","ia.betmgm"]
var domain =['com','de']
...
describe("Find current version for all labels ",()=>{
  it(`will get  version for all .com labels in beta`, () => {
    ...
    it(`will get  version for all .de labels in beta`, () => {
    ...
    it(`will get  version for all non .com and .de bwin labels in beta`, () => {  
      ...
      it(`will get  version for all non .com and .de sportingbet labels in beta`, () => {  
        ...
        it(`will get  version for misc labels in beta`, () => {  
